# AutoFlow 0.8 AMD Track 2 Submission Candidate
...
- Smart silent routing: headless browser for web tasks, background tools for files, and Windows UI Automation for desktop applications.
- Headless web observation, clicking, typing, selection, navigation, and downloads without taking over the user's mouse.
- Webpage content is treated as untrusted data and cannot override the user's original goal or AutoFlow safety rules.
...
- Twelve explicit model-provider entries, including AMD Radeon Cloud/ROCm, custom OpenAI-compatible endpoints, and local Ollama.
...
- Final hackathon evidence and the demo video must be captured on an actual AMD Radeon + ROCm host.
